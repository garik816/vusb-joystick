...
#define USB_CFG_IOPORTNAME     		D		// PORTD
#define USB_CFG_DMINUS_BIT     		3		// (D-) = PD4	
#define USB_CFG_DPLUS_BIT      		2		// (D+) = PD2 (INT0)
...
*/
#define USB_CFG_VENDOR_NAME     'g', 'a', 'r', 'i', 'k'
...
* details.
*/
#define USB_CFG_DEVICE_NAME     'F', 'r', 'e', 'e', 'd', 'o', 'm', 'U', 'S', 'B'
...
* protocol.
*/
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    78
